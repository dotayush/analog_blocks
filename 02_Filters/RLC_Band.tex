      ...
      \begin{enumerate}
        \item Due to \(V_{1}\) alone (\(V_{2} = 0V\)):
          ...
          \begin{align*}
            ...
            H_1(s) = \frac{N_1(s)}{D_1(s)} = \frac{V_{out_1}}{V_{1}} &= \frac{G_1}{G_1 + \frac{1}{sL_1} + sC_1}
          \end{align*}
        \item Due to \(V_{2}\) alone (\(V_{1} = 0V\)):
          ...
          \begin{align*}
            ...
            H_2(s) = \frac{N_2(s)}{D_2(s)} = \frac{V_{out_2}}{V_{2}} &= \frac{\frac{1}{sL_1} + sC_1}{G_1 + \frac{1}{sL_1} + sC_1}
          \end{align*}
      \end{enumerate}
    ...
    \paragraph{Superposition:}
      \begin{enumerate}
        \item Due to \(V_{1}\) alone (\(V_{2} = 0V\)):
          ...
          This results in:
          \[
            H_3(s) = \frac{N_3(s)}{D_3(s)} = \frac{V_{out_3}}{V_{1}} = \frac{sC_1}{sC_1 + G_1(1 + s^2 L_1 C_1)}
          \]
        \item Due to \(V_{2}\) alone (\(V_{1} = 0V\)):
          This is the band stop characteristic of the RLC Band Filter.\\
          Substituting equation (3) into equation (1):
          ...
          This results in:
          \[
            H_4(s) = \frac{N_4(s)}{D_4(s)} = \frac{V_{out_4}}{V_{2}} = \frac{G_1(1 + s^2 L_1 C_1)}{sC_1 + G_1(1 + s^2 L_1 C_1)}
          \]
      \end{enumerate}
    ...
    \begin{enumerate}
      \item \textbf{Parallel Configuration:}
        ...
        \begin{align*}
          ...
          s = \frac{-G_1 \pm \sqrt{G_1^2 - \frac{4 C_1}{L_1}}}{2 C_1}
        \end{align*}
      ...
      \item \textbf{Series Configuration:}
        ...
        \begin{align*}
          ...
          s = \frac{-1 \pm \sqrt{1 - \frac{4 G_1^2 L_1}{C_1}}}{2 L_1 G_1}
        \end{align*}
        While the nature of the poles depends on the value of the
      ...
      \item \textbf{Parallel Configuration:}\\
        ...
        For band stop \(H_2(s)\):
          \begin{align*}
            ...
            f_z = \frac{|s_z|}{2\pi} = \frac{\sqrt{\frac{1}{L_1 C_1}}}{2\pi} = \frac{1}{2\pi \sqrt{L_1 C_1}}
          \end{align*}
        ...
        \begin{enumerate}
          \item \textbf{At Input}:
            ...
            \begin{align*}
              ...
              Z_{in} &= R_1 + Z_{LC} \\
              Z_{in} = R_1 + j \left(\omega L_1 - \frac{1}{\omega C_1}\right)
            \end{align*}
          \item \textbf{At Output}:
            \(L_1\) and \(C_1\) are in series with each other and
            their combination is in parallel with \(R_1\):
            \begin{align*}
              ...
              Z_{LC} &= j \left(\omega L_1 - \frac{1}{\omega C_1}\right) \\
              Z_{out} &= \frac{R_1 \cdot Z_{LC}}{R_1 + Z_{LC}} \\
              Z_{out} = \frac{R_1 \cdot j \left(\omega L_1 - \frac{1}{\omega C_1}\right)}{R_1 + j \left(\omega L_1 - \frac{1}{\omega C_1}\right)}
            \end{align*}
          \end{enumerate}
    \end{enumerate}
\end{enumerate}
