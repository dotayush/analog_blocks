...
\begin{enumerate}
  \item \textbf{Poles (\(D(s) = 0\)):} \\
    For both \(H_1(s)\) and \(H_2(s)\):
      \begin{align*}
        ...
        s_p &= -\frac{G_1}{C_1} \\
        s_p &= -\frac{1}{R_1 C_1} \quad \text{(Substituting } G_1 = \frac{1}{R_1} \text{)} \\
      \end{align*}
  ...
  \item \textbf{Zeroes (\(N(s) = 0)\)):} \\
    For $H_1(s)$:
      \begin{align*}
        N_1(s) = G_1 = 0 \quad\Rightarrow\quad \text{No Zeroes}
      \end{align*}
    No zeroes for \(H_1(s)\). \\
    For $H_2(s)$:
      \begin{align*}
        N_2(s) = sC_1 = 0 \quad\Rightarrow\quad s_z &= 0 \\
  ...
  \item \textbf{DC Gain (\(H(0)\)):} \\
    For \(H_1(s)\):
      \begin{align*}
        H_1(0) &= \frac{G_1}{G_1 + 0} = 1 \\
        \boxed{A_{DC_1} = 1 = 0 dB}
      \end{align*}
    Gain is unity at DC for \(H_1(s)\). \\
    For \(H_2(s)\):
      \begin{align*}
        H_2(0) &= \frac{0}{G_1 + 0} = 0 \\
        \boxed{A_{DC_2} = 0 = -\infty dB}
      \end{align*}
    Gain is zero at DC for \(H_2(s)\).
