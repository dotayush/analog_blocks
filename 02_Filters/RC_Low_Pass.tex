...
\raggedright
Applying KCL at $V_{out}$ on Small-Signal Schematic, we get:
\begin{equation}
  \begin{aligned}
...
\begin{enumerate}
  \item \textbf{Transfer Function:} Rearranging KCL gives:
    \begin{align*}
      V_{out}(G_1 + sC_1) - V_{in}G_1 &= 0 \\
      V_{out}(G_1 + sC_1) &= V_{in}G_1 \\
      V_{out} &= \frac{V_{in}G_1}{G_1 + sC_1} \\
      \boxed{H(s) = \frac{N(s)}{D(s)} = \frac{V_{out}}{V_{in}} = \frac{G_1}{(G_1 + sC_1)}} \\
    \end{align*}
  \item \textbf{Poles (\(D(s) = 0\)):}
    \begin{align*}
      G_1 + sC_1 &= 0 \\
      s &= -\frac{G_1}{C_1} \\
      \boxed{\text{Pole at } s = -\frac{1}{R_1 C_1}}
    \end{align*}
  ...
  \item \textbf{Zeroes (\(N(s) = 0\)):}
    \begin{align*}
      \boxed{G_1 = 0}
    \end{align*}
    \textbf{There are no finite zeros in this transfer function.}
  \item \textbf{DC Gain (\(A_{DC} = H(0)\)):}
    \begin{align*}
      A_{DC} &= \lim_{s \to 0} \frac{G_1}{G_1 + sC_1} \\
      A_{DC} &= \frac{G_1}{G_1 + 0} \\
      \boxed{A_{DC} = 1}
    \end{align*}
  \item \textbf{Gain-Bandwidth Product (GBW):}
    \begin{align*}
      GBW &= f_p \times A_{DC} \\
      \boxed{GBW = \frac{1}{2 \pi R_1 C_1}}
    \end{align*}
