...
\[
  \frac{V_{out} - V_{in}}{sL_1} + (V_{out} - V_{ee}){G_1} = 0
\]
\paragraph{Superposition:}
\begin{enumerate}
  \item Due to \(V_{in}\) alone (\(V_{ee} = 0V\)):
    \begin{align*}
      \frac{(V_{out} - V_{in})}{sL_1} + (V_{out} - 0){G_1} &= 0 \\
      \frac{V_{out}}{sL_1} - \frac{V_{in}}{sL_1} + V_{out}G_1 &= 0 \\
      V_{out}(G_1 + \frac{1}{sL_1}) - \frac{V_{in}}{sL_1} &= 0 \\
      V_{out}(G_1 + \frac{1}{sL_1}) &= \frac{V_{in}}{sL_1} \\
      V_{out} &= \frac{\frac{V_{in}}{sL_1}}{(G_1 + \frac{1}{sL_1})} \\
      V_{out} &= \frac{1}{L_1 s G_1 + 1}V_{in} \\
      \boxed{H_1(s) = \frac{N_1(s)}{D_1(s)} = \frac{V_{out_1}}{V_{in}} = \frac{1}{L_1 s G_1 + 1}}
    \end{align*}
  \item Due to \(V_{ee}\) alone (\(V_{in} = 0V\)):
    \begin{align*}
      \frac{(V_{out} - 0)}{sL_1} + (V_{out} - V_{ee}){G_1} &= 0 \\
      \frac{V_{out}}{sL_1} + V_{out}G_1 - V_{ee}G_1 &= 0 \\
      V_{out}(G_1 + \frac{1}{sL_1}) - V_{ee}G_1 &= 0 \\
      V_{out}(G_1 + \frac{1}{sL_1}) &= V_{ee}G_1 \\
      V_{out} &= \frac{V_{ee}G_1}{(G_1 + \frac{1}{sL_1})} \\
      V_{out} &= \frac{sL_1 G_1}{G_1 s L_1 + 1}V_{ee} \\
      \boxed{H_2(s) = \frac{N_2(s)}{D_2(s)} = \frac{V_{out_2}}{V_{ee}} = \frac{sL_1 G_1}{G_1 s L_1 + 1}}
    \end{align*}
\end{enumerate}
...
\begin{align*}
  ...
  \boxed{V_{out} = \frac{1}{L_1 s G_1 + 1} V_{in} + \frac{sL_1 G_1}{G_1 s L_1 + 1} V_{ee}}
\end{align*}
...
\begin{enumerate}
    ...
    \item \textbf{DC Gain (\(H(0)\)):} \\
      For \(H_1(s)\):
      \begin{align*}
        H_1(0) &= \frac{1}{L_1 (0) G_1 + 1} \\
        H_1(0) &= 1
      \end{align*}
      Unity DC gain for \(H_1(s)\). \\
      For \(H_2(s)\):
      \begin{align*}
        H_2(0) &= \frac{(0) L_1 G_1}{G_1 (0) L_1 + 1} \\
        H_2(0) &= 0
      \end{align*}
    ...
    \item \textbf{Gain-Bandwidth Product (\(GBW\)):}
      ...
      \begin{align*}
        GBW &= A_{DC} \times f_p \\
        GBW &= 1 \times \frac{R_1}{2 \pi L_1} = \frac{R_1}{2 \pi L_1}
      \end{align*}
    \item \textbf{Impedances:}
      ...
      \paragraph{At Output:}
        \begin{align*}
          ...
          \boxed{Z_{out} = \frac{\omega^2 R_1 L_1^2}{R_1^2 + (\omega L_1)^2} + j \frac{\omega R_1^2 L_1}{R_1^2 + (\omega L_1)^2}}
        \end{align*}
\end{enumerate}
