...
Constructed from a resistor and inductor in series. An RL
Pass Filter can be broken down into two types:
\begin{itemize}
  \item \textbf{Low Pass Filter:} Allows low frequency signals to pass while attenuating high frequency signals.
  \item \textbf{High Pass Filter:} Allows high frequency signals to pass while attenuating low frequency signals.
\end{itemize}
It is a single pole filter but can be used in multiple stages
to create higher order filters.
...
\begin{enumerate}
  \item Due to \(V_{1}\) alone (\(V_{2} = 0V\)):
    ...
    \begin{align*}
      ...
      \boxed{H_1(s) = \frac{N_1(s)}{D_1(s)} = \frac{V_{out_1}}{V_{1}} = \frac{1}{L_1 s G_1 + 1}}
    \end{align*}
  \item Due to \(V_{2}\) alone (\(V_{1} = 0V\)):
    ...
    \begin{align*}
      ...
      \boxed{H_2(s) = \frac{N_2(s)}{D_2(s)} = \frac{V_{out_2}}{V_{2}} = \frac{sL_1 G_1}{G_1 s L_1 + 1}}
    \end{align*}
\end{enumerate}
...
\begin{align*}
  ...
  \boxed{V_{out} = \underbrace{\frac{1}{L_1 s G_1 + 1}V_{1}}_{\text{Low Pass Character}} + \underbrace{\frac{sL_1 G_1}{G_1 s L_1 + 1}V_{2}}_{\text{High Pass Character}}}
\end{align*}
