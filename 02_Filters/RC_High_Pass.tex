...
\begin{enumerate}
  \item \textbf{Poles (\(D(s) = 0\)):} \\
    ...
    \begin{align*}
      ...
      s &= -\frac{G_1}{C_1} \\
    \end{align*}
    Negative real pole \(\Rightarrow\) stable first-order system. Frequency
  ...
  \item \textbf{Zeroes (\(N(s) = 0\)):} \\
    For \(H_1(s)\):
    \begin{align*}
      N_1(s) \quad\rightarrow\quad sC_1 = 0 \\
      s_z &= 0
    \end{align*}
    Zero at the origin for \(H_1(s)\). \\
    For \(H_2(s)\):
    \begin{align*}
      N_2(s) \quad\rightarrow\quad G_1 = 0 \\
      \text{No finite zeroes.}
    \end{align*}
  ...
  \item \textbf{DC Gain \(A_{DC}\):} \\
    ...
    \end{align*}
    Gain is zero at DC for \(H_1(s)\). \\
    For \(H_2(s)\):
    \begin{align*}
      H_2(0) &= \frac{G_1}{0 \cdot C_1 + G_1} = 1 \\
      \boxed{A_{DC_2} = 1 = 0 dB}
    \end{align*}
    Gain is unity at DC for \(H_2(s)\).
