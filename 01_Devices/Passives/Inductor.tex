...
\begin{itemize}
  ...
  \item \textbf{Circuit Analysis:}
    The behaviour of inductor is affected by the kind of Input Signal (AC
    or DC) applied to it. Find the admittance before deciding weather to
    Short, Open or keep the inductor as is within your analysis. Table~\ref{tab:hand-analysis-simplifications}
