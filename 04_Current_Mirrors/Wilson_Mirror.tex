...
\begin{enumerate}
  \item \textbf{Large Signal Analysis}:
    ...
    \begin{align*}
      ...
      (V_{y} - V_{cc})G_3 + I_{M_0} &= 0 \hspace{1cm} \text{[KCL at } V_{y}\text{]} \\
    ...
    Thus,
    \begin{align*}
      \frac{I_{out}}{I_{in}} \approx \frac{I_{M_2}}{I_{M_0}} \approx \frac{I_{M_1}}{I_{M_0}} \approx \frac{k_{n_1}}{k_{n_0}} = \frac{\frac{\mu_n C_{ox} W_1}{L_1}}{\frac{\mu_n C_{ox} W_0}{L_0}} = \frac{\frac{W_1}{L_1}}{\frac{W_0}{L_0}} = \frac{W_1 L_0}{L_1 W_0}
    \end{align*}
  ...
  \item \textbf{Impedance}:
    ...
    \paragraph{At Output:} Applying a test current $I_{test}$
      ...
      \begin{align*}
        ...
        V_{out}(G_4 + g_{o_2}) - V_{x}(g_{o_2} + g_{m_2}) + g_{m_2}\left(\frac{-g_{m_0}V_{x}}{G_3 + g_{o_0}}\right) &= I_{test} \quad \text{[rearranging (9)]} \\
...
\begin{lstlisting}[language=Octave]
  ...
  % input impedance: Itest injected into Vy
