...
\begin{enumerate}
  \item Due to \(V_{cc}\) alone (\(V_{ee} = 0V\)):
    \begin{align*}
      ...
      \boxed{H_1(s) = \frac{N_1(s)}{D_1(s)} = \frac{V_{out_1}}{V_{cc}} = \frac{C_1}{C_1 + C_2}}
    \end{align*}
  \item Due to \(V_{ee}\) alone (\(V_{cc} = 0V\)):
    \begin{align*}
      ...
      \boxed{H_2(s) = \frac{N_2(s)}{D_2(s)} = \frac{V_{out_2}}{V_{ee}} = \frac{C_2}{C_1 + C_2}}
    \end{align*}
\end{enumerate}
  ...
  \item \textbf{Impedance's:}
    ...
    \paragraph{At Output:}
      \begin{align*}
        ...
        \boxed{Z_{out} = \frac{1}{s(C_1 + C_2)}} = \frac{1}{sC_{eq}} \hspace{1cm} \text{(where \(C_{eq} = C_1 + C_2\))}
      \end{align*}
