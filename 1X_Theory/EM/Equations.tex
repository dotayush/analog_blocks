...
\begin{itemize}
  ...
  \item \( \mathbf{J_m(x,y,z,t)} \): magnetic current density function.
    ...
    magnetic monopoles i.e. charges haven't been observed.
\end{itemize}
...
\begin{itemize}
  ...
  \item \( \mathbf{J_e(x,y,z,t)} \): electric current density function.
    ...
    electric monopoles i.e. charges have been observed. It is defined as
...
\subsection{Statics and Quasi-Statics}
