...
Do you see it isn't just $R_2$ anymore? Normally $R_1$, $R_3$,
$L_1$, $L_2$, $L_3$, and $C_{13}$ are very small compared to
$R_2$ and can be ignored at low frequencies. However, at high
frequencies, these parasitics can significantly affect the
