...
Similarly, if the output impedance of Box 2 (\(Z_{out_2}\)) is not
negligible compared to the input impedance of Box 3 (\(Z_{in_3}\)),
then Box 2 and Box 3 will also form a voltage divider.

To minimize loading effects, We usually keep $Z_{out_1}$ about 10
times smaller than $Z_{in_2}$ and $Z_{out_2}$ about 10 times smaller
than $Z_{in_3}$.

\textbf{This a thumb rule and doesn't apply if you're dealing with
either Active Circuits, Current Sources, Radio Frequency Circuits
