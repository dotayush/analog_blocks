...
\label{sec:theory_general_second_order}

A second order system is one that can be describe by a
differential equation of order 2 in time domain which
transforms into polynomial with degree 2 in Laplace
...
\begin{enumerate}
  ...
  \item The Normalized form: We divide the entire polynomial
    by the coefficient of \( s^2 \) to make it unity.
    \begin{equation*}
...
\begin{enumerate}
  \item \textbf{Normalized Form vs. Factored Form}
    ...
    \begin{enumerate}
      \item \textbf{Two distinct real poles (overdamped):} Assume \( p_2 = k p_1 \) with \( k \in \mathbb{R} \), \( k \neq 1 \).
        ...
        \end{align*}
        For large \(k\):
        \[ \boxed{k \approx \frac{a_1^2}{a_0 a_2}} \]
      ...
      \item \textbf{Two complex conjugate poles (underdamped):} Let \( p_{1,2} = \alpha \pm j\beta \), with \( \alpha, \beta \in \mathbb{R} \).
        ...
        \begin{align*}
          ...
          \quad \Rightarrow \quad
          \boxed{\beta = \sqrt{\frac{a_0}{a_2} - \frac{a_1^2}{4a_2^2}}}
        \end{align*}
    \end{enumerate}
  ...
  \item \textbf{Factored Form vs. Natural Form}
    ...
    \[ \boxed{Q = \frac{\sqrt{p_1 p_2}}{p_1 + p_2}}\]
    ...
    \begin{enumerate}
      ...
      \item \textbf{Two complex conjugate poles (underdamped):} With \( p_{1,2} = \alpha \pm j\beta \),
        \begin{align*}
           ...
           \boxed{ Q = \frac{\sqrt{\alpha^2 + \beta^2}}{\alpha}}
         \end{align*}
    \end{enumerate}
